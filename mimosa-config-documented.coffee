...
exports.config = {
  ...
  ###
  modules: ["server","minify-js","minify-css","jshint","csslint","live-reload","require","bower","copy","minify-img","require-lint","stream-copy","testem-require","web-package"]
  ...
  minifyImg:
    ...
    options:                             # pass through options to https://github.com/kevva/image-min      interlaced: false                  # Interlace gif for progressive rendering.
  ...
  streamCopy: # array of extensions for files to stream copyand not process otherwise
